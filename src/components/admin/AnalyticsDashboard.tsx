    ...
    <div className="px-4 py-6 sm:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white shadow rounded-lg p-6">
          <h3 className="text-lg font-semibold text-gray-700 mb-2">Total Completions</h3>
          <p className="text-3xl font-bold text-blue-600">{analytics.global.totalCompletions}</p>
        </div>
        <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Achievement ID</th>
